...
print(numbers)
#TA-STEPHAN: Did not display the number of elements in the list, just the numbers
# Should use len.
...
print("2nd-largest value",sorted_numbers[1])

#Display the last element of the original unsorted list
#print(len(numbers)) #7
print(numbers[len(numbers) - 2])
#TA-STEPHAN: Should be -1, not -2 if you use this method.
...
#TA-STEPHAN: You're missing a few conditions here. Here's an example of the full
#for loop.
