...
#TA-STEPHAN: No need to print here. Will only give you 'none.'
print(countries.sort())

# Display the first element of the list
print(countries[0])
print("This is the re-ordered countries: ", " ,".join(countries))


#TA-STEPHAN: Didn't diplay the second to last element. Try countries[-2]
